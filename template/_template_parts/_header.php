            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php if (isset($_SESSION["id_utilisateur"])) : ?>
                        <li class="burgerDisplayMobile"><a class="nav-link" href="./compte.php">Mon compte</a></li>
                        <li class="burgerDisplayMobile"><a class="nav-link" href="./deconnexion.php">Déconnexion</a></li>
                    <?php else : ?>
                        <li class="burgerDisplayMobile"><a class="nav-link" href="./connexion.php">Connexion</a></li>
                        <li class="burgerDisplayMobile"><a class="nav-link" href="./inscription.php">Créer un compte</a></li>
                    <?php endif ?>
                </ul>

                <div id="burgerDisplayDesktop">
